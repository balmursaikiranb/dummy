...
public class PaymentWalletDao implements IPaymentWalletDao{
	...
	public Wallet depositMoney(String phone, BigDecimal balance) throws PaymentWalletException {
		Wallet wallet=accounts.get(phone);
                    if(wallet!=null)
                    {
                        ...
                        builder1.append("*");
                        builder1.append(("you have deposited money: ").concat(balance.toString().concat(now.toString())));
	...
	public Wallet withdrawMoney(String phone, BigDecimal balance) throws PaymentWalletException {
        ...
        if(wallet.getBalance()==big){
					...
					StringBuilder builder1=new StringBuilder(str1);
					builder1.append("*");
					builder1.append(("you have withdrawed money: ").concat(balance.toString().concat(now.toString())));
					transactions.put(phone,builder1.toString());
					return wallet;
        }
        else
                ...
                if((wallet!=null)&&(wallet1!=null))
                {
                     ...
                     if(wallet.getBalance()==big){
                      ...
                      BigDecimal updateBalance=((wallet.getBalance()).subtract(balance));
                        ...
                        builder1.append((" of amount: ").concat(balance.toString()).concat(now.toString()));
                        ...
                        builder.append((" of amount: ").concat(balance.toString()).concat(now.toString()));
	...
	public HashMap<String, String> printTransaction(String phone) throws PaymentWalletException {
		Wallet wallet=accounts.get(phone);
                if(wallet!=null)
                {
